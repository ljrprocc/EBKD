...
class ConditionalVAE(nn.Module):
    def __init__(self,
        ...
        self.decoder_input = nn.Linear(latent_dim + num_classes, self.hidden_dims[-1] * 4)
    ...
    def forward(self, input: Tensor, **kwargs) -> List[Tensor]:
        ...
        return  [x_rec, input, mu, log_var, oriz]
    ...
    def sample(self,
        ...
        mu = samples
        # print(mu)
        repara_flag = kwargs['train']
        if repara_flag:
            samples = mu + 0.1 * torch.randn_like(mu)
