...
CUDA_VISIBLE_DEVICES=1 python train_ebm.py --model_s resnet28x10 --trial 2_st_random --capcitiy 10000 --path_t ./save/models/resnet32x4_svhn_lr_0.01_decay_0.0005_trial_0/resnet32x4_best.pth --g_steps 20 --save_freq 2 --epochs 50 --lr_decay_epochs 7,40 --plot_cond --learning_rate 0.00003 --batch_size 128 --energy mcmc --warmup_iters 1500 --lmda_p_x_y 0. --lmda_p_x 1. --step_size 1. --act swish --num_workers 4 --data_noise 0.03 --print_freq 100 --dataset svhn --model resnet32x4 --model_stu resnet8x4