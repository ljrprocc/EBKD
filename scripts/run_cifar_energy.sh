...
echo "**************** $i th training**************"
CUDA_VISIBLE_DEVICES=4 python train_student.py --batch_size 128 --model_s MobileNetV2  --distill attention -a 0 -b 1000 --path_t ./save/models/vgg13_vanilla/ckpt_epoch_240.pth  --trial ${i}_ebm --num_workers 4 --learning_rate 0.01 --epochs 300 --G_step 1 --mode energy
done
