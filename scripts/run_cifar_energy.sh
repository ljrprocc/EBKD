...
echo "**************** $i th training**************"
CUDA_VISIBLE_DEVICES=3 python train_student.py --batch_size 128 --model_s wrn_16_1  --distill kd -r 0.1 -a 0.9 -b 0 --path_t ./save/models/wrn_40_2_vanilla/ckpt_epoch_240.pth  --trial ${i}_ebm --num_workers 4 --learning_rate 0.01 --epochs 300 --G_step 1 --mode energy
done
