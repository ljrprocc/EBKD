...
echo "**************** $i th training**************"
CUDA_VISIBLE_DEVICES=4 python train_student.py --batch_size 128 --model_s resnet8x4  --distill kd -r 0.3 -a 0.7 -b 0 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth  --trial ${i}_deepinv --num_workers 4 --learning_rate_ebm 0.01 --epochs 300 --datafree --norm batch --df_folder /data/lijingru/DeepInversion/cifar10/runs/data_generation/paper_parameters_resnet32x4/best_images/
done
