...
echo "**************** $i th training**************"
CUDA_VISIBLE_DEVICES=4 python train_student.py --batch_size 128 --model_s resnet8x4  --distill kd -r 0.3 -a 0.7 -b 0 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth  --trial ${i}_5000_g_100 --num_workers 4 --learning_rate_ebm 0.01 --epochs 300 --datafree --norm batch --df_folder /data/lijingru/EBKD/save/student_model/resnet28x10_cifar100_lr_0.0001_decay_0.0_buffer_size40000_lpx_0.0_lpxy_1.0_energy_mode_mcmc_trial_fresh_3/img_sample_eval/
done
