...
echo "**************** $i th training**************"
CUDA_VISIBLE_DEVICES=5 python train_student.py --batch_size 128 --model_s resnet8x4  --distill kd -r 0.01 -a 0.99 -b 0 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth  --trial ${i}_vae_lc_2 --num_workers 4 --learning_rate_ebm 0.01 --epochs 300 --datafree --norm batch --df_folder /data/lijingru/EBKD/save/student_model/cifar100_lr_0.005_decay_0.0_ndf_256_trial_2/vae_samples/
done
