...
# echo "**************** $i th training**************"
CUDA_VISIBLE_DEVICES=4 python train_student.py --batch_size 128 --model_s resnet8x4  --distill kd -r 0.1 -a 0.9 -b 0 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth  --trial 0_df --num_workers 4 --learning_rate 0.01 --epochs 300 --G_step 1 --datafree --mode energy
# done
