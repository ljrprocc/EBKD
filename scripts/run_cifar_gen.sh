...
CUDA_VISIBLE_DEVICES=1 python train_ebm.py --model_s wrn_28_10 --trial cor_multi_5 --capcitiy 10000 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth --g_steps 20 --save_freq 5 --epochs 150 --lr_decay_epochs 50,100 --plot_cond --learning_rate 0.0002 --batch_size 128  --energy mcmc --warmup_iters 1000 --lmda_p_x_y 1. --lmda_p_x 0. --step_size 1. --act swish --num_workers 4 --data_noise 0.03 --print_freq 100 --use_py --reinit_freq 0.05 --print_freq 100 --multiscale
