...
# python train_ebm.py --config ./configs/gz.yaml --trial short_run --save_freq 20 --epochs 100 --batch_size 1024  --warmup_iters 1000 --num_workers 4 --print_freq 10 --gpu 1

python train_ebm.py --config ./configs/jem.yaml --trial short_run --save_freq 10 --epochs 100 --batch_size 256 --warmup_iters 1000 --num_workers 4 --print_freq 50 --gpu 6
