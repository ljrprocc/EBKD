...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=6 python train_ebm.py --model_s resnet28x10 --trial 1_random_xy --capcitiy 10000 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth --g_steps 20 --save_freq 10 --epochs 200 --lr_decay_epochs 50,150 --plot_cond --learning_rate 0.00001 --batch_size 128  --energy mcmc --warmup_iters 1000 --lmda_p_x_y 0. --lmda_p_x 1. --step_size 1. --act leaky --num_workers 4 --data_noise 0.03 --print_freq 100 --use_py --init_epochs 120 --load_buffer_path /data/lijingru/EBKD/save/student_model/resnet28x10_T:resnet32x4_S:resnet8x4_cifar100_lr_0.0001_decay_0.0_buffer_size_10000_lpx_0.0_lpxy_1.0_energy_mode_mcmc_step_size_1.0_trial_3_lc_random_cls_mode_cls/res_epoch_120.pts --joint --model resnet32x4 --lc_K 5 --st -1 --model_stu resnet8x4