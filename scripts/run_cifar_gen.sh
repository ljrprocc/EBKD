...
CUDA_VISIBLE_DEVICES=1 python train_ebm.py --model_s wrn_28_10 --trial cor_multi_4 --capcitiy 10000 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth --g_steps 20 --save_freq 5 --epochs 200 --lr_decay_epochs 70,130 --plot_cond --learning_rate 0.0001 --batch_size 128  --energy mcmc --warmup_iters 1000 --lmda_p_x_y 0. --lmda_p_x 1. --step_size 1. --act swish --num_workers 4 --data_noise 0.03 --print_freq 100 --use_py --reinit_freq 0.03 --print_freq 100 --multiscale --load_buffer_path /data/lijingru/EBKD/save/student_model/cifar100_wrn_28_10_cifar100_lr_0.0002_decay_0.0_buffer_size_10000_lpx_1.0_lpxy_0.0_energy_mode_mcmc_step_size_2.0_trial_cor_multi_4/res_epoch_80.pts --init_epochs 80
