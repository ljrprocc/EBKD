...
CUDA_VISIBLE_DEVICES=1 python train_ebm.py --model_s resnet28x10 --trial 2_st_5 --capcitiy 10000 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth --g_steps 20 --save_freq 10 --epochs 200 --lr_decay_epochs 100,150 --plot_cond --learning_rate 0.0001 --batch_size 128  --energy mcmc --warmup_iters 1000 --lmda_p_x_y 0. --lmda_p_x 1. --step_size 1. --act leaky --num_workers 4 --data_noise 0.03 --print_freq 100 --use_py --lc_K 5 --joint --st 5 --model resnet32x4 --model_stu resnet8x4
