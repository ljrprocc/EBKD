...
CUDA_VISIBLE_DEVICES=0 python train_ebm.py --model_s resnet8x4 --trial 1_mi --capcitiy 90000 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth --g_steps 20 --save_freq 25 --epochs 200 --lr_decay_epochs 50,100 --plot_cond --learning_rate 0.0002 --batch_size 128  --energy mcmc --warmup_iters 1000 --lmda_p_x_y 1. --lmda_p_x 0.5 --step_size 2