...
CUDA_VISIBLE_DEVICES=1 python train_ebm.py --model_s resnet28x10 --trial 1_st_random --capcitiy 10000 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth --g_steps 20 --save_freq 2 --epochs 150 --lr_decay_epochs 70,90 --plot_cond --learning_rate 0.00001 --batch_size 64  --energy mcmc --warmup_iters 1000 --lmda_p_x_y 0. --lmda_p_x 1. --step_size 1. --act leaky --num_workers 4 --data_noise 0.03 --print_freq 100 --use_py --joint --model resnet32x4 --model_stu resnet8x4 --lc_K 10 --st -1 --load_buffer_path /data/lijingru/EBKD/save/student_model/resnet28x10_T:resnet32x4_S:resnet8x4_cifar100_lr_0.0001_decay_0.0_buffer_size_10000_lpx_1.0_lpxy_0.0_energy_mode_mcmc_step_size_1.0_trial_1_st_random_cls_mode_cls_k_10/res_epoch_90.pts --init_epochs 90
