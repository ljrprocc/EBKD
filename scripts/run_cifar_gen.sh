...
CUDA_VISIBLE_DEVICES=1 python train_ebm.py --model_s wrn_28_10 --trial cor_random --capcitiy 10000 --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth --g_steps 20 --save_freq 2 --epochs 200 --lr_decay_epochs 130,150 --plot_cond --learning_rate 0.0001 --batch_size 128  --energy mcmc --warmup_iters 1500 --lmda_p_x_y 0. --lmda_p_x 1. --step_size 1. --act swish --num_workers 4 --data_noise 0.03 --print_freq 100 --use_py --reinit_freq 0.05
