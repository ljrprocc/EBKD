...
# wget -c http://shape2prog.csail.mit.edu/repo/vgg13_vanilla/ckpt_epoch_240.pth -T 5 -t 10000
# mv ckpt_epoch_240.pth vgg13_vanilla/

mkdir -p ResNet50_vanilla
wget -c http://shape2prog.csail.mit.edu/repo/ResNet50_vanilla/ckpt_epoch_240.pth -T 5 -t 10000
